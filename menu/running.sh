...
echo -e ""
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m            xploitoverload SYSTEM INFORMATION            \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m          xploitoverload SUBSCRIPTION INFORMATION         \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;32m Client Name \e[0m: $Name"
echo -e "\e[1;32m Exp Script  \e[0m: $Exp"
echo -e "\e[1;32m Version     \e[0m: 1.0"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m             xploitoverload SERVICE INFORMATION            \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m                    https://github.com/xploitoverload                   \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo ""
