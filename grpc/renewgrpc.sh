...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/etc/xray/vmessgrpc.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
		clear
		echo ""
		echo "You have no existing clients! by xploitoverload"
		exit 1
	fi

	clear
	echo ""
	echo "Select the existing client you want to renew by xploitoverload"
...
echo ""
echo "==============================="
echo " xploitoverload XRAY Vmess/Vless gRPC Account Renewed by xploitoverload  "
echo "==============================="
echo "Username  : $user"
echo "Expired   : $exp4"
echo "==============================="
