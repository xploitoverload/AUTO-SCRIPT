...
show_vps_info() {
    ...
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e "\e[1;34m                  xploitoverload VIP AIO               \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_cpu_ram_info() {
    ...
    echo -e "\e[1;34m                xploitoverload CPU/RAM INFO             \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
...
show_menu() {
    ...
    echo -e "\e[1;34m                   xploitoverload MENU                  \e[0m"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
    ...
    echo -e "\e[1;32m SCRIPT BY   \e[0m: xploitoverload"
    echo -e "\e[1;32m MADE BY     \e[0m: xploitoverload"
    echo -e "\e[1;33m -------------------------------------------------\e[0m"
    echo -e ""
