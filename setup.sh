...
if test $dns -eq 1; then
  wget https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/ssh/cf && chmod +x cf && ./cf
...
#install ssh ovpn
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen      Install sparkypanel SSH Websocket           $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "\e[33m-----------------------------------\033[0m"
echo -e "$BGreen          Install xploitoverload XRAY              $NC"
echo -e "\e[33m-----------------------------------\033[0m"
sleep 0.5
clear
wget https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/menu/versi  )
...
echo ""
curl -s https://kalpeshsolanki.me | tee -a log-install.txt
echo ""
...
echo "---------------------------t.me/xploitoverload-----------------------------" | tee -a log-install.txt
