...
# domain random
#CDN="https://raw.githubusercontent.com/xploitoverload/AUTO-SCRIPT/master/ssh"
cd /root
...
sleep 0.5
clear
# install ssh-vpn from xploitoverload
...
echo "---------------------------https://github.com/xploitoverload-----------------------------" | tee -a log-install.txt
